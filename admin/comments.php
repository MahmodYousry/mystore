<?php
	...
	*/
					...
					<?php
						foreach ($comments as $comment) {
							echo "<tr>";
								...
								echo "<td>
										<a href='comments.php?do=Edit&comid=" . $comment['c_id'] . "' class='btn btn-success'><i class='fa fa-edit'></i> Edite</a>
	...
	<?php
      		...
      		// Check If Get Request comid Is Numberic & Get The Integer Value of it.
